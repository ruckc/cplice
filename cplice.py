...
parser.add_argument(
    "basecontainer", help="Base software container to use for the new container"
)
parser.add_argument(
    "datacontainer", help="Container with the model data to use for the new container"
)
...
cplice = ContainerSplice(
    args.basecontainer, args.datacontainer, args.newcontainer, verify=not args.insecure
)
